...
Remote-SSH, operational, and implementation notes that previously lived on the
project landing page. Commands assume the repository root unless stated
otherwise. For the shortest supported path, use the packaged Windows beta in
the main README.
